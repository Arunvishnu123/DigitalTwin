    ...
    <w-drawer width="120em" class="newthing" v-model="$store.state.createThing" :[position]="true">
        ...
        <w-flex column>
            ...
            <w-form @submit.prevent="sendThing">
                ...
                <w-input v-model="sensorType" class="mb6" label="Sensor Type" outline></w-input>
                <w-divider class="ma6" color="white" />
                <w-flex>
                    <w-input v-model="eventBasedTarget" class="mb6" label="Event based target" outline>
                    </w-input>
                    <w-input v-model="eventTargetType" class="mb6" label="Target type" outline>
                    </w-input>
                    <w-input v-model="eventContentType" class="mb6" label="Content type" outline>
                    </w-input>
                </w-flex>
                ...
                <w-flex>
                    <w-input v-model="historicalTarget" class="mb6" label="Histroical Target" outline>
                    </w-input>
                    <w-input v-model="historicalTargetType" class="mb6" label="Target type" outline>
                    </w-input>
                    <w-input v-model="historicalContentType" class="mb6" label="Content type" outline>
                    </w-input>
                </w-flex>
